...
JNIEXPORT jlong JNICALL Java_com_jlangen_vaultbox_crypto_NativeAESCipherSpi_nInit(JNIEnv *env, jobject this, jboolean encrypting, jbyteArray key, jbyteArray iv) {
  uint8_t ckey[32];
  aes_state *state;
...
JNIEXPORT void JNICALL Java_com_jlangen_vaultbox_crypto_NativeAESCipherSpi_nCleanup(JNIEnv *env, jclass this, jlong state) {
  free((void *)state);
}
...
JNIEXPORT jint JNICALL Java_com_jlangen_vaultbox_crypto_NativeAESCipherSpi_nUpdate(JNIEnv *env, jobject this,
...
*/
JNIEXPORT jint JNICALL Java_com_jlangen_vaultbox_crypto_NativeAESCipherSpi_nFinal(JNIEnv *env, jobject this,
...
JNIEXPORT jint JNICALL Java_com_jlangen_vaultbox_crypto_NativeAESCipherSpi_nGetCacheSize(JNIEnv* env, jobject this, jlong state) {
  aes_state *c_state;
...
JNIEXPORT jbyteArray JNICALL Java_com_jlangen_vaultbox_crypto_finalkey_NativeFinalKey_nTransformMasterKey(JNIEnv *env, jobject this, jbyteArray seed, jbyteArray key, jlong rounds) {
  master_key mk;
  uint32_t flip;
  pthread_t t1, t2;
  int iret;
